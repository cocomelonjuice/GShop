      ...
      <div>
        <div className="rounded-lg shadow-lg hover:border-blue-600 hover:shadow-2xl pb-2 pt-2 ">
          ...
          {authUser ? (
            <button
              onClick={addToCart}
              className=" rounded-b-lg rounded-t-lg  border-blue-600 border-2 bg-blue-600 text-white px-1 hover:bg-red-400 "
            >
              Add to Cart
            </button>
          ) : (
            <Link to="/authentication/LoginForm">
              <button className=" rounded-b-lg  border-blue-600 border-2 bg-blue-600 text-white px-1 hover:bg-red-400 ">
                Add to Cart
              </button>
            </Link>
          )}
