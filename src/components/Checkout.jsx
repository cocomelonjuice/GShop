...
const Checkout = () => {
  ...
  return (
  <div className="bg-teal-200 rounded-xl mt-8 mr-96 w-full h-fit pt-6 pb-4 "> {/*m-auto inset-0 absolute w-1/2 h-1/4*/}
    <h1>CHECKOUT</h1>
    ...
    <div className="grid grid-cols-2 gap-4 ">
      <div>Shipping</div> 
        ...
        <div>Coupon</div>    
        <input className='border-2 rounded-md border-black' type="text"></input>
    </div>
    </div>
    ...
    <button className='m-auto mt-2 hover:bg-red-600 bg-red-400 w-fit px-2 py-2 rounded-lg text-white'>CONFIRM ORDER</button>
  </div>
)
}
